            ...
            <div className="container px-4">
              ...
              <div className="flex flex-row mb-2.5 ">
                ...
                {content && content.emailActivated ? (
                  <span class="bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-green-400 border border-green-400 ml-3">
                    Email sudah terverifikasi
                  </span>
                ) : (
                  <div>
                    <span class="pb-2 bg-red-100 text-red-800 text-xs font-medium  px-3.5 py-1.5 rounded dark:bg-gray-700 dark:text-red-400 border border-red-400 ml-3">
              ...
              <div className="flex flex-row justify-items-center">
                ...
                {content && content.emailActivated ? (
                  ...
                  <button
                    className="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded ml-3 pl-2 pr-2 pb-1 pt-1"
                    onClick={verivEmailHandler}
                  >
                    Verifikasi Email
                  </button>
                )}
            ...
            <div className="container px-4">
              ...
              <div className="flex flex-row justify-items-center">
                ...
                {content && content.emailActivated ? (
                  ...
                  <button
                    className="bg-transparent hover:bg-blue-500 text-blue-500 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded ml-3 pl-2 pr-2 pb-1 pt-1"
                    onClick={verivEmailHandler}
                  >
                    Verifikasi Email
                  </button>
