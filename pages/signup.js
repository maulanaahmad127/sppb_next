...
export default function SignUp() {
  ...
  return (
    <>
    <Head>
        <title>Sign Up - Sistem Pencatatan Produksi Beras</title>
    ...
    <div className="my-10 mx-auto flex w-fit justify-center rounded-sm border border-stroke bg-white shadow-default">
      <div className="flex flex-wrap items-center">
        ...
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="py-12 px-20 text-center">
        ...
        <div className="w-full border-stroke xl:w-1/2 xl:border-l-2 px-6 my-7">
          ...
          <p className="mb-2.5 opacity-50">Daftarkan akun ke Sistem Pencatatan Produksi Beras</p>
            ...
            <div className="mb-5 relative">
              ...
              <input
                className="w-full rounded-lg border bg-transparent py-3 px-4 outline-none focus:border-blue-600 focus-visible:shadow-none"
                type="text"
                name="username"
            ...
            <div className="mb-5 relative">
              ...
              <input
                ...
                onChange={(event) => setNo_handphone(event.target.value)}
                autoComplete="off"
              />
              <span className="absolute right-4 bottom-4">
                <svg
            ...
            <div className="mb-5 relative">
              ...
              <select
                ...
                name="jenisKelamin"
                id="jenisKelamin"
                onInputCapture={(event) => setJenis_kelamin(event.target.value)}
              >
            ...
            <div className="mb-5 relative">
              ...
              <select
                ...
                name="role"
                id="role"
                onInputCapture={(event) => setRole(event.target.value)}
              >
            ...
            <button
              className="w-full cursor-pointer rounded-lg border border-indigo-600 bg-indigo-600 p-4 text-white transition hover:bg-opacity-80"
